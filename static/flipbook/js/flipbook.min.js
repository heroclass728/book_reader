...
!function (M, L, C, a) {
  M.fn.flipBook = function (e) {
    ...
    deeplinkingPrefix: "",
    assets: {
      preloader: "/static/flipbook/images/preloader.jpg",
      overlay: "/static/flipbook/images/overlay.png",
      flipMp3: "/static/flipbook/mp3/turnPage.mp3",
      spinner: "/static/flipbook/images/spinner.gif"
    },
    pdfUrl: null,
    ...
    var o, s = C.createElement("div").style, a = function () {
        for (var e = "t,webkitT,MozT,msT,OT".split(","), t = 0, o = e.length; t < o; t++) if (e[t] + "ransform" in s) return e[t].substr(0, e[t].length - 1);
        return !1
      }(), r = /android/gi.test(navigator.appVersion), l = /iphone|ipad/gi.test(navigator.appVersion),
    ...
    if (this.strings = P.strings, P.pageShininess = P.pageShininess / 2, this.s = 0, P.googleAnalyticsTrackingCode && (this.gaCode = P.googleAnalyticsTrackingCode, L.ga || (g = C, f = "script", b = "ga", (u = L).GoogleAnalyticsObject = b, u.ga = u.ga || function () {
      ...
      x()
    }).css("cursor", "pointer") : x(); else if (P.isIE && P.pdfBrowserViewerIfIE && P.pdfUrl) P.lightBox && !P.lightBoxOpened ? this.$elem.on("touched click", function () {
      x()
    }).css("cursor", "pointer") : x(); else {
      ...
      var B = {
        _events: {}, on: function (e, t) {
          ...
          if (this._events[e]) {
            var t = 0, o = this._events[e].length;
      ...
      }), P.lightBoxOpened ? (O(), M(this).trigger("lightboxLoadingStarted")) : P.lightboxPreload && ("undefined" != typeof IScroll || FLIPBOOK.scriptsAdded[FLIPBOOK.iscrollSrc] || n.loadScript(FLIPBOOK.iscrollSrc, function () {
      }), P.pdfMode && ("undefined" != typeof pdfjsLib || FLIPBOOK.scriptsAdded[FLIPBOOK.pdfjsSrc] || n.loadScript(FLIPBOOK.pdfjsSrc, function () {
      ...
      }))), this.fullscreenElement = C.documentElement) : (P.btnClose.enabled = !1, this.preloader.appendTo(this.wrapper), this.wrapper.appendTo(this.$elem), this.fullscreenElement = this.$elem[0], O())
    }
    ...
    start: function () {
      ...
      var e = null, t = L.location.hash, o = "#" + this.options.deeplinkingPrefix;
      ...
      if (void 0 !== this.currentPage) {
        var e, t = this.options.rightToLeft, o = this.options.numPages, i = this.Book.rightIndex || 0;
      ...
      1 == this.options.numPages && (this.options.viewMode = "swipe", this.options.singlePageMode = !0, this.webgl = !1), this.loadPage(0, this.options.pageTextureSize, function () {
        if (n.setLoadingProgress(.5), 1 == n.options.pages.length) {
          ...
          var e = n.options.pages[0].img, t = n.options.pages[1].img, o = e.width / e.height, i = t.width / t.height;
      ...
      var i = this;
      if (this.options.pdfMode) this.loadPageFromPdf(e, t, o); else {
        i = this;
      ...
      var n = this, s = C.createElement("script"), e = C.getElementsByTagName("script")[0];
      ...
      var n = this, e = this.model, t = this.options;
      ...
      if (this.options.numPages = this.options.pages.length, this.options.numPages % 2 == 0 || this.options.singlePageMode || (this.oddPages = !0, this.options.oddPages = !0, this.options.pages.push({
        ...
        thumb: ""
      })), 0 < n.options.pages.length) for (i = 0; i < n.options.pages.length; i++) void 0 !== n.options.pages[i].htmlContent && (n.options.hasHtmlContent = !0, n.options.pages[i].htmlContent = M(n.options.pages[i].htmlContent));
      ...
      var e = this.options.pages, t = this.id;
      for (var o in e) {
        var i = e[o];
        if (i.items) for (var n in i.items) {
          var s = i.items[n];
          switch (s.type) {
            case"iframe":
      ...
      if (1 != this.options.numPages) {
        ...
        L.jQuery(this.bookLayer).swipe({
          ...
          }, fingers: 2, pinchThreshold: 0, allowPageScroll: "vertical", preventDefaultEvents: !1
        }), this.swipeEnabled = !0
      }
    }, toggleMenu: function () {
      ...
      var o = this.options, e = "top" == t.vAlign && o.menu2Transparent || "top" != t.vAlign && o.menuTransparent,
        ...
        r = e ? o.floatingBtnTextShadow : o.btnTextShadow, l = t.radius || (e ? o.floatingBtnRadius : o.btnRadius),
        d = t.border || (e ? o.floatingBtnBorder : o.btnBorder), h = e ? o.floatingBtnMargin : o.btnMargin,
        p = M(C.createElement("span")), c = "material" == o.icons ? (t.size || o.btnSize) + 8 : t.size || o.btnSize,
      ...
      var e = this.options, t = e.menuFloating ? "flipbook-menu-floating" : "flipbook-menu-fixed",
        o = e.menu2Floating ? "flipbook-menu-floating" : "flipbook-menu-fixed", i = this;
      ...
      var o = M(e).attr("data-name"), i = this.options;
      switch (o) {
        case"btnFirst":
          this.firstPage();
          break;
        ...
        case"btnDownloadPdf":
          if (i.btnDownloadPdf.forceDownload) {
            var s = i.btnDownloadPdf.url, a = C.createElement("a");
            a.href = s;
      ...
      var e, o = this, i = this.options, t = "flipbook-currentPageHolder ";
      ...
      var n = "top" == i.currentPage.vAlign && i.menu2Transparent || "top" != i.currentPage.vAlign && i.menuTransparent,
        s = n ? i.floatingBtnBackground : "", a = n ? i.floatingBtnColor : i.btnColor,
        r = n ? i.floatingBtnTextShadow : "", l = n ? i.floatingBtnRadius : i.btnRadius,
      ...
      var i = this, n = M("<div>").addClass("flipbook-menu-header skin-clor flipbook-font").appendTo(e),
      ...
      var t = this, e = this.options.tableOfContent;
      ...
      if (this.shareMenu) this.shareMenuShowing ? (this.shareMenu.hide(), this.shareMenuShowing = !1) : (this.shareMenu.show(), this.closeMenus(), this.shareMenuShowing = !0); else {
        ...
        var o = M('<idv class="flipbook-share">').appendTo(t), i = this.options;
      ...
      if (this.options.pages[e] && this.options.pages[e].download) url = this.options.pages[e].download; else if (this.options.pages[e] && this.options.pages[e].src) url = this.options.pages[e].src; else if (this.options.pages[e] && this.options.pages[e].canvas && this.options.pages[e].canvas[this.options.pageTextureSize]) {
        var t = C.createElement("canvas"), o = this.options.pageWidth / this.options.pageHeight;
      ...
      L.jQuery.extend(L.jQuery.easing, {
        def: "easeOutQuad", swing: function (e, t, o, i, n) {
    ...
    rightIndex: 0, goToPage: function () {
    }
  }, FLIPBOOK.Thumbnails = function (o) {
    var i = this, n = o.options, e = o.wrapper;
    if (this.main = o, this.options = n, this.wrapper = e, this.active = null, n.btnThumbs.enabled) {
      ...
      var t = n.pages, s = [];
      if (n.doublePage) for (var a = 0; a < t.length; a++) 0 != a && a % 2 == 0 || s.push(t[a]); else s = t;
      n.pdfMode && this.loadThumbsFromPdf(s);
      var r = n.thumbSize, l = n.thumbSize * n.pageWidth / n.pageHeight;
      for (a = 0; a < s.length; a++) {
        ...
        if (this.thumbs.push(h), s[a].thumbCanvas) var c = M(s[a].thumbCanvas); else {
          if (!d) continue;
    ...
    loadThumbsFromPdf: function (e) {
      ...
      this.main.pdfDocument.getPage(e + 1).then(function (e) {
        var t = e.getViewport(1), o = l.options.thumbSize / t.height, i = e.getViewport(o),
          n = r[e.pageIndex].thumbCanvas, s = n.getContext("2d");
    ...
    openLightbox: function () {
      this.lightboxOpened || (this.lightboxOpened = !0, this.overlay.css("display", "none"), this.overlay.fadeIn("slow", function () {
      }), M("body").addClass("flipbook-overflow-hidden"), M("html").addClass("flipbook-overflow-hidden"))
  ...
  var t = e.dataset.bookid, o = e.dataset.page;
  ...
  var s = "undefined" != typeof window && void 0 !== window.document ? window.document : {},
    ...
    n = "undefined" != typeof Element && "ALLOW_KEYBOARD_INPUT" in Element, a = function () {
      for (var e, t = [["requestFullscreen", "exitFullscreen", "fullscreenElement", "fullscreenEnabled", "fullscreenchange", "fullscreenerror"], ["webkitRequestFullscreen", "webkitExitFullscreen", "webkitFullscreenElement", "webkitFullscreenEnabled", "webkitfullscreenchange", "webkitfullscreenerror"], ["webkitRequestFullScreen", "webkitCancelFullScreen", "webkitCurrentFullScreenElement", "webkitCancelFullScreen", "webkitfullscreenchange", "webkitfullscreenerror"], ["mozRequestFullScreen", "mozCancelFullScreen", "mozFullScreenElement", "mozFullScreenEnabled", "mozfullscreenchange", "mozfullscreenerror"], ["msRequestFullscreen", "msExitFullscreen", "msFullscreenElement", "msFullscreenEnabled", "MSFullscreenChange", "MSFullscreenError"]], o = 0, i = t.length, n = {}; o < i; o++) if ((e = t[o]) && e[1] in s) {
        for (o = 0; o < e.length; o++) n[t[0][o]] = e[o];
        return n
      }
      return !1
    }(), i = {change: a.fullscreenchange, error: a.fullscreenerror}, t = {
      request: function (i) {
        return new Promise(function (e) {
          var t = a.requestFullscreen, o = function () {
            this.off("change", o), e()
          }.bind(this);
...
}(navigator.userAgent || navigator.vendor || window.opera), function (e) {
  ...
  function i(e, f) {
    ...
    function i(e) {
      var t, o = e.originalEvent ? e.originalEvent : e, i = o.touches;
      if (i) {
    ...
    function p() {
      var e = g(), t = v(), o = null === f.pinchThreshold || q >= f.pinchThreshold;
      return e && t && o
    }
    ...
    function y(e) {
      var t = void 0 !== e.identifier ? e.identifier : 0, o = J[t] || null;
    ...
    function I(e, t) {
      var o = Math.abs(e.x - t.x), i = Math.abs(e.y - t.y);
    ...
    var z = Le || Ie || !f.fallbackToMouseEvents,
      ...
      H = Ie ? Ce ? "MSPointerCancel" : "pointercancel" : "touchcancel", R = 0, N = null, j = null, $ = 0, W = 0, V = 0,
      U = 1, q = 0, Z = 0, Q = null, Y = re(e), X = "start", G = 0, J = {}, ee = 0, te = 0, oe = 0, ie = 0, ne = 0,
      se = null, ae = null;
    try {
    ...
    this.enable = function () {
      ...
      if ("object" == typeof e) f = re.extend(f, e); else if (void 0 !== f[e]) {
  ...
  var le = "left", de = "right", he = "up", pe = "down", ce = "in", ue = "out", ge = "none", fe = "auto", be = "swipe",
    me = "pinch", ke = "tap", ve = "doubletap", we = "longtap", Pe = "horizontal", Se = "vertical", Be = "all", xe = 10,
    Te = "start", Oe = "move", ye = "end", Me = "cancel", Le = "ontouchstart" in window,
    Ce = window.navigator.msPointerEnabled && !window.navigator.pointerEnabled && !Le,
    Ie = (window.navigator.pointerEnabled || window.navigator.msPointerEnabled) && !Le, Fe = "TouchSwipe";
  re.fn.swipe = function (e) {
    var t = re(this), o = t.data(Fe);
    ...
    } else if (o && "object" == typeof e) o.option.apply(o, arguments); else if (!(o || "object" != typeof e && e)) return function (o) {
    ...
    IN: ce,
    OUT: ue
  }, re.fn.swipe.pageScroll = {NONE: ge, HORIZONTAL: Pe, VERTICAL: Se, AUTO: fe}, re.fn.swipe.fingers = {
    ONE: 1,
    TWO: 2,
    THREE: 3,
    FOUR: 4,
